...
let Engin = (() => {
    ...
    var Engin = _classThis = class {
        constructor() {
            this.id = __runInitializers(this, _id_initializers, void 0);
            this.type = (__runInitializers(this, _id_extraInitializers), __runInitializers(this, _type_initializers, void 0));
            this.numero = (__runInitializers(this, _type_extraInitializers), __runInitializers(this, _numero_initializers, void 0));
            __runInitializers(this, _numero_extraInitializers);
        }
    };
    __setFunctionName(_classThis, "Engin");
    (() => {
        ...
        Engin = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return Engin = _classThis;
})();
exports.Engin = Engin;
